import{_ as l,I as p,c as h,o as k,aj as i,j as a,J as t,aP as e,aQ as r}from"./chunks/framework.BN_rKFww.js";const o=JSON.parse('{"title":"5.3 分类和检测","description":"医学图像分析中的深度学习分类和检测技术","frontmatter":{"title":"5.3 分类和检测","description":"医学图像分析中的深度学习分类和检测技术"},"headers":[],"relativePath":"guide/ch05/03-classification.md","filePath":"zh/guide/ch05/03-classification.md"}'),E={name:"guide/ch05/03-classification.md"};function d(g,s,y,c,F,b){const n=p("Mermaid");return k(),h("div",null,[s[1]||(s[1]=i("",121)),a("details",null,[s[0]||(s[0]=a("summary",null,"📖 查看原始Mermaid代码",-1)),t(n,{id:"mermaid-207b87nu7",code:`flowchart TD
    A[医学图像分析任务] --> B{数据类型？}
